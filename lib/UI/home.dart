import 'dart:convert';
import 'package:weather_app_fl/UI/detail_page.dart';
import 'package:weather_app_fl/widgets/weather_items.dart';
import 'package:http/http.dart' as http;
import 'package:flutter/material.dart';
import 'package:weather_app_fl/models/city.dart';
import 'package:weather_app_fl/models/constants.dart';
...
class _HomeState extends State<Home> {
  ...
  String location = 'herat'; //Our default city
  ...
  String url =
      "https://api.weatherapi.com/v1/forecast.json?key=e895c165d7af4dd39ec103720232107&q=";
  // String searchWeatherUrl = 'https://www.metaweather.com/api/location/';

  Shader? get linearGradient => null; //to get weather details using the woeid
  ...
  void fetchLocation(String location) async {
    ...
    var searchResult = await http.get(Uri.parse(url + location));
  ...
  void fetchWeatherData() async {
    var weatherResult = await http.get(Uri.parse(url + location));
    var result = json.decode(weatherResult.body);
    // print(result);
    // var a = result['current']['temp_c'];
    var a = result['current']['condition']['text'];
    // print('---$a');
    ...
    setState(() {
      ...
      // print("===set state $temperature");
      weatherStateName = result['current']['temp_c'];
      humidity = result['humidity'].round();
